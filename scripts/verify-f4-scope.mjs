...
const BASE_COMMIT = "61939ffb1e423b20a330c0ef4eda0673bb951dba";
...
assert.ok(touched.length > 0, "La compuerta F5.2A esperaba cambios locales o comprometidos");
assert.equal(
...
console.log(
  `qa:scope PASS (base ${BASE_COMMIT}; ${touched.length} paths F5.2A autorizados)`
);
